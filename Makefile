main: main.o entity.o  render.o snake.o texture.o
	 gcc  main.o entity.o render.o snake.o texture.o -o main  -I /usr/local/include/SDL2 -L /usr/local/lib -lSDL2 -lSDL2_image
